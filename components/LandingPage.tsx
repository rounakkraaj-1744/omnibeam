...
export function LandingPage({ onGetStarted }: LandingPageProps) {
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      {/* Header */}
      <header className="border-b border-neutral-900 sticky top-0 bg-[#0a0a0a]/80 backdrop-blur-lg z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-8">
            ...
            <a href="#docs" className="text-sm font-medium text-neutral-400 hover:text-neutral-200 transition-colors">Docs</a>
            <a href="#pricing" className="text-sm font-medium text-neutral-400 hover:text-neutral-200 transition-colors">Pricing</a>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 md:py-28">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#4F46E5]/10 border border-[#4F46E5]/20 rounded-full mb-8">
            <Zap className="w-4 h-4 text-[#4F46E5]" />
            <span className="text-sm font-medium text-[#4F46E5]">Now in Public Beta</span>
          </div>
          
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold mb-6 bg-gradient-to-r from-white via-neutral-200 to-neutral-400 bg-clip-text text-transparent leading-tight">
          ...
          <div className="mt-20 relative">
            <div className="bg-gradient-to-b from-[#111111] to-[#0a0a0a] border border-neutral-900 rounded-2xl p-10 shadow-2xl">
              <div className="flex items-center justify-center gap-12 flex-wrap">
                <div className="flex flex-col items-center gap-4">
                  <div className="w-20 h-20 bg-[#4F46E5]/10 border border-[#4F46E5]/20 rounded-xl flex items-center justify-center">
                    <Zap className="w-10 h-10 text-[#4F46E5]" />
                  </div>
                  <span className="text-sm font-medium text-neutral-400">API</span>
                </div>

                <div className="hidden md:block flex-1 max-w-xs h-px bg-gradient-to-r from-transparent via-neutral-800 to-transparent" />
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <span className="text-xs font-medium text-neutral-500">Slack</span>
                  </div>
                  <div className="flex flex-col items-center gap-3">
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-semibold mb-4 text-neutral-100">Built for developers</h2>
          <p className="text-lg text-neutral-400">Everything you need to send notifications at scale</p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-[#111111] border border-neutral-900 rounded-xl p-6 hover:border-neutral-800 transition-all">
            <div className="w-12 h-12 bg-[#4F46E5]/10 border border-[#4F46E5]/20 rounded-lg flex items-center justify-center mb-4">
              <Radio className="w-6 h-6 text-[#4F46E5]" />
            </div>
            <h3 className="mb-2 text-neutral-100">Multi-Channel Support</h3>
          ...
          <div className="bg-[#111111] border border-neutral-900 rounded-xl p-6 hover:border-neutral-800 transition-all">
            ...
            <h3 className="mb-2 text-neutral-100">Programmable Retries</h3>
            <p className="text-sm text-neutral-400">
          ...
          <div className="bg-[#111111] border border-neutral-900 rounded-xl p-6 hover:border-neutral-800 transition-all">
            ...
            <h3 className="mb-2 text-neutral-100">Real-time Delivery Logs</h3>
            <p className="text-sm text-neutral-400">
          ...
          <div className="bg-[#111111] border border-neutral-900 rounded-xl p-6 hover:border-neutral-800 transition-all">
            ...
            <h3 className="mb-2 text-neutral-100">Unified API Keys</h3>
            <p className="text-sm text-neutral-400">
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="#" className="text-sm text-neutral-500 hover:text-neutral-300 transition-colors">GitHub</a>
              <a href="#" className="text-sm text-neutral-500 hover:text-neutral-300 transition-colors">Privacy</a>
              <a href="#" className="text-sm text-neutral-500 hover:text-neutral-300 transition-colors">Terms</a>
            </div>
          </div>
